...
In the previous steps of the Conservation Standards cycle, your team developed your strategic plan, monitoring plan, and operational plan (Figure 8). In this step, you need to turn these general plans into more specific ones and then implement them on an ongoing basis.
...
As your project moves along, you should revisit the project assumptions in your theories of change and update your work plan regularly, again focusing on the more detailed activities for the next few months. Figure 18 shows an example of a table with people assigned to work on the project’s actions and monitoring activities.
...
|SHARK M2. Train & support local observers -|SHARK M2. Train & support local observers -|4|4|8|-|1,250|1,250|2,500|4,750|
