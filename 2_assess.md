...
**Conservation scope:** broad parameters of the project

**Project vision:** ultimate state or condition the project is working to achieve

**Biodiversity focal values:** ecosystems or species a team chooses to represent the overall biodiversity of a site or the focus of a thematic project

**Ecosystem services:** services that well conserved biodiversity focal values may

**Human wellbeing values:** components of human wellbeing affected by the status of conservation targets or directly by conservation actions

**Human wellbeing** **scope:** human populations to whom the project is of interest
...
**Factors** broadly include any element in a situation model; **Contributing factors** include indirect threats, opportunities, or other factors leading to direct threats Dotted lines can help depict **uncertainty in relationships** Depending upon the context, it may not be useful to identify indirect threats or opportunities for **climate threats** an **opportunity**

Question marks can show **uncertainty** about the presence of a factor
...
If your team includes human wellbeing focal values in your situation model, you should show how key factors in your situation model affect those focal values, either directly or through the status of biodiversity focal values and associated **ecosystem** **services** . Figure 7 shows an example of how a threat to biodiversity may also threaten human health, as well as how the status of a focal value and its ecosystem services can affect human wellbeing.

FIGURE **7**

**Example Situation Model Extract with Human Wellbeing Focal Values**

*Note: This figure provides an alternative way to show the relationship between your biodiversity focal values and human wellbeing focal values that may resonate with different audiences. See [CMP (2016) Incorporating Social Aspects and Human Wellbeing in Biodiversity Conservation Projects](https://conservationstandards.org/library-item/addressing-human-wellbeing) for further guidance. Note this guidance will likely be updated over time.